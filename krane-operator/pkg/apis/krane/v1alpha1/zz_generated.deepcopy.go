...
func (in *AnalysisPhaseSpec) DeepCopyInto(out *AnalysisPhaseSpec) {
	*out = *in
	if in.Cmd != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnalysisPhaseSpec.
func (in *AnalysisPhaseSpec) DeepCopy() *AnalysisPhaseSpec {
	if in == nil {
		return nil
	}
	out := new(AnalysisPhaseSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CanarySpec) DeepCopyInto(out *CanarySpec) {
	*out = *in
	in.TestPhase.DeepCopyInto(&out.TestPhase)
	in.AnalysisPhase.DeepCopyInto(&out.AnalysisPhase)
	return
}
